...
To have the same range with a 88-key piano, with six strings, you have to add more frets. I checked when fret number is 65, the range can be 88 keys, which is kidn of crazy. We may need to add more strings.
